...
def assert_destination(cursor: Any, *, database: str, instance: str = "") -> dict[str, Any]:
    ...
    **``DB_NAME()`` alone is not an identity.** One estate had ``HRMS_Prod`` on both the UAT and
    ...
    may name the instance (``HRMS-DB\\HRMS``) without knowing the host's full computed name.
    """
